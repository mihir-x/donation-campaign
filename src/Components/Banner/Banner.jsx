...
const Banner = ({ handleSearch }) => {
    ...
    return (
        <div className=" bg-[url('https://i.ibb.co/qmhrpkw/donation.jpg')] bg-cover bg-[#fffffff2] h-[50vh] flex flex-col justify-center text-center">
            <div className=' space-y-2 md:space-y-4 lg:space-y-10 w-full h-full bg-slate-100/90 backdrop-brightness-100 flex flex-col justify-center text-center'>
                <div>
